        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicPassportId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ownerships_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnershipTransfer", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_PublicPassportId",
                table: "Devices",
                column: "PublicPassportId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Ownerships_DeviceId",
                table: "Ownerships",
                column: "DeviceId",
                unique: true,
